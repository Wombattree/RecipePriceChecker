...
function ListCategories(data)
{
    for (let i = 0; i < data.meals.length; i++)
    {
        ...
        newCategoryElement.attr('class','button is-success is-light is-hovered is-one-fifth')
...
{
    $('.title').attr('class','is-hidden');
    $('.subtitile').attr('class','is-hidden');
    $('#sectionHide').addClass('position');
    ...
    for (let i = 0; i < data.meals.length; i++)
    {
        ...
        newMealElement.attr('class','column is-3')
        newMealElementImage.appendTo(recipeInCategoryListElement);
        newMealElementImage.attr('class','column is-3 px-25')
    }
}
...
function DisplayUserRecipes()
{
    for (let i = 0; i < userRecipes.length; i++) 
    {
        ...
        newUserRecipeDisplay.attr('class','button is-warning is-light is-hovered')
